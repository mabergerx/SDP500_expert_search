...
# These functions were used to extract all the paper tags for IDCG calculation
# and also include the citation counts for each paper. Used in the final weighted
# IDCG calculation.
