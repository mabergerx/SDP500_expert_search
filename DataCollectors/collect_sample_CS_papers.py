...
# These functions were used for the initial approach of data collection by
# collecting all the papers from the OAG if the ID of the paper was
# in a list of the collected Computer Science tagged papers.
